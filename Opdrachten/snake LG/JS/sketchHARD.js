...
let length = 1;
let score = 0;
let highScoreH= localStorage.getItem('highScoreH') ? parseInt(localStorage.getItem('highScoreH')) : 0;
...
function draw() {
  if (shopClicked) {
    ...
    text("Highscore: " + highScoreH, 655, 20);
    ...
    if (gameOver) {
      ...
      text("Highscore: " + highScoreH, width / 2, height / 2 + 120);
...
function generateGame() {
  ...
  highScoreH = localStorage.getItem('highScoreH') ? parseInt(localStorage.getItem('highScoreH')) : 0;
