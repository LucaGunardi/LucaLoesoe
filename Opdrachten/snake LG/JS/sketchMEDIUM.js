...
let length = 1;
let score = 0;
let highScoreM= localStorage.getItem('highScoreM') ? parseInt(localStorage.getItem('highScoreM')) : 0;
...
function draw() {
  if (shopClicked) {
    ...
    text("Highscore: " + highScoreM, 655, 20);
    ...
    if (gameOver) {
      ...
      text("Highscore: " + highScoreM, width / 2, height / 2 + 120);
...
function generateGame() {
  ...
  highScoreM = localStorage.getItem('highScoreM') ? parseInt(localStorage.getItem('highScoreM')) : 0;
